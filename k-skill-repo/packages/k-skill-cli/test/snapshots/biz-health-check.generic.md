...
1. **본인의 실사·거래 확인 목적으로만 쓴다.** 거래 상대방의 사업 상태를 확인하는 실사(듀 디리전스) 참고 도구로 한정하고, 특정 개인사업자에 대한 신용 평가·등급화·명단화 서비스로 운영하지 않는다.
2. **이미 공개된 공공 정보만 조합한다.** 각 섹션은 국세청·국민연금공단·금융위원회·조달청·지방행정이 공식 공개한 정보를 조회시점 그대로 병렬할 뿐, 비공개 정보를 수집하거나 새로운 개인정보를 생성하지 않는다.
3. **대량·정기 수집에는 목적과 근거를 먼저 확인한다.** 특정 사업자 목록을 반복·대량으로 조회하려는 요청에는 활용 목적과 법적 근거를 먼저 묻고, 근거가 불명확하면 진행하지 않는다.
4. **결과 보관은 최소화한다.** 리포트는 요청 시점 참고용으로 한정하고 장기 저장·재배포하지 않는다. 개인사업자 결과에는 대표자명·체납액 등 공개 범위 내 개인정보가 포함될 수 있음을 안내한다.
