...
1. **공단이 공식 공개한 사업장 정보만 조회한다.** 가입자수·고지금액은 국민연금공단이 공공데이터포털로 공개한 사업장 단위 정보이며, 개별 근로자의 개인정보는 조회·추정하지 않는다.
2. **조회 목적을 명시한다.** 거래처 실사, 입사 검토, 시장 조사 같은 정당한 확인 목적의 개별 조회로 한정하고, 특정 사업장·업종의 대량·정기 수집에는 목적과 법적 근거를 먼저 확인한다. 근거가 불명확하면 진행하지 않는다.
3. **결과 저장은 최소화한다.** 조회 결과는 요청 시점 참고용으로 한정하고 장기 저장·재배포하지 않는다.
